...
close all; clear all;
n = 4; % How many .csv files do you want to build your model on?
for i = 1:n
    %% Import data
...
[OF_mdl,CV_amean,CV_asem,acc_fig] = bsoid_mdl(f_10fps,grp,0.2,70,200); % Change 70 and 200 to <= (training data size *0.2). 
