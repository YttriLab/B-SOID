function [f_10fps,tsne_feats,grp,llh,bsoid_fig] = bsoid_gmm(data,fps,comp,smth_hstry,smth_futr,kclass,it)
...
%   
%   [FEATS,TSNE_FEATS,GRP,LLH,BSOID_FIG] = BSOID(DATA,FPS,COMP,SMTH_HSTRY,SMTH_FUTR,KCLASS,IT) outputs classified behaviors based on DeepLabCut analysis
%
%   INPUTS:
